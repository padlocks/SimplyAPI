    ...
    create = async () => {
        ...
        return new Promise(async (resolve) => {
            await axios.post(`${this.API().url}/customFront`, JSON.stringify(customFront.content), {
                ...
                .catch(err => console.error(`<CustomFront>.create() method threw an error: ${err.message}\nReason: ${err.response?.data}`))
        })
    }
    ...
    update = async () => {
        ...
        return new Promise(async (resolve) => {
            await axios.patch(`${this.API().url}/customFront/${customFront.id}`, customFront.content, {
                ...
                .catch(err => console.error(`<CustomFront>.update() method threw an error: ${err.message}\nReason: ${err.response?.data}`))
        })
    }
    ...
    delete = async () => {
        ...
        return new Promise(async (resolve) => {
            await axios.delete(`${this.API().url}/customFront/${customFront.id}`, {
                ...
                .catch(err => console.error(`<CustomFront>.delete() method threw an error: ${err.message}\nReason: ${err.response?.data}`))
        })
    }
}
