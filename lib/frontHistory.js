    ...
    create = async () => {
        ...
        return new Promise(async (resolve) => {
            await axios.post(`${this.API().url}/frontHistory`, JSON.stringify(customFront.content), {
                ...
                .catch(err => console.error('<FrontHistory>.create() method threw an error: ' + err.message || err.response.data))
        })
    }
    ...
    remove = async () => {
        ...
        return new Promise(async (resolve) => {
            await axios.patch(`${this.API().url}/frontHistory/${customFront.id}`, patchedFront, {
                ...
                .catch(err => console.error('<FrontHistory>.remove() method threw an error: ' + err.message || err.response.data))
        })
    }
    ...
    update = async () => {
        ...
        return new Promise(async (resolve) => {
            await axios.patch(`${this.API().url}/frontHistory/${customFront.id}`, customFront, {
                ...
                .catch(err => console.error('<FrontHistory>.update() method threw an error: ' + err.message || err.response.data))
        })
    }
    ...
    delete = async () => {
        ...
        return new Promise(async (resolve) => {
            await axios.delete(`${this.API().url}/frontHistory/${customFront.id}`, {
                ...
                .catch(err => console.error('<FrontHistory>.delete() method threw an error: ' + err.message || err.response.data))
        })
    }
    ...
    getComments = async () => {
        ...
        return new Promise(async (resolve) => {
            await axios.get(`${this.API().url}/comments/${this.type}/${customFront.id}`, {
                ...
                .catch(err => console.error('<frontHistory>.getComments() method threw an error: ' + err.message || err.response.data))
        })
    }
}
