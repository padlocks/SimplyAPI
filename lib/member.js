...
class Member extends SAPI {
    ...
    syncToPK = async (options) => {
        ...
        return new Promise(async (resolve) => {
            if (!this.API().pk_token) return console.error('<Member>.syncToPK() method threw an error: method requires a PluralKit token (pkToken)')
    ...
    syncFromPK = async (options) => {
        ...
        return new Promise(async (resolve) => {
            if (!this.API().pk_token) return console.error('<Member>.syncFromPK() method threw an error: method requires a PluralKit token (pkToken)')
